...
// ──────────────────────────────────────────────
// utilidad para ejecutar el MDX generado
// ──────────────────────────────────────────────
...
// ──────────────────────────────────────────────
// Headings bonitos con clases por nivel
// ──────────────────────────────────────────────
...
// 👇 este cast es la clave para que TS no grite en build
const CopyBlock = CodeBlockWithCopy as React.ComponentType<any>;

// ──────────────────────────────────────────────
// Mapeo de componentes que el MDX puede usar
// ──────────────────────────────────────────────
const components = {
  Image: (props: any) => (
    <Image
  ...
  a: ({ className, ...props }: any) => {
    ...
    // caso: link que envuelve una imagen
    if (hasImage) {
      return (
        <Link
          className={cn(
  ...
  tr: ({ className, ...props }: React.HTMLAttributes<HTMLTableRowElement>) => (
    <tr
      className={cn(
        "m-0 border-t border-muted p-0 even:bg-muted/45",
        className,
      )}
      {...props}
    />
  ...
  pre: ({ className, children, ...props }: any) => {
    // intentamos extraer el código literal
    ...
    return (
      <CopyBlock code={code}>
        <pre
          className={cn(
            "my-2 overflow-x-auto rounded-lg scrollbar-thin scrollbar-track-slate-100 scrollbar-thumb-slate-400",
            className,
          )}
          {...props}
        >
...
// ──────────────────────────────────────────────
// Componente principal que usas en la página
// ──────────────────────────────────────────────
...
export default function MDXComponent({ code, title }: MDXComponentProps) {
  ...
  // extraemos los h1, h2 renderizados para el TOC
  useEffect(() => {
