 ...
 * SVGGradientBg
 * ------------------------------------------------------------
 * Fondo decorativo en SVG con blur + degradado rojo/negro.
 *
 * - Cambia el `viewBox` y el `path` según el tamaño de pantalla
 *   (mobile vs desktop) para que el shape no se deforme.
 * - Se posiciona absoluto detrás del contenido.
 * - Pensado para usarse dentro de layouts/modales como background.
 *
 * Nota: como usa `window`, debe ser "use client".
 */
export default function SVGGradientBg() {
  // viewBox y path cambian según el viewport
